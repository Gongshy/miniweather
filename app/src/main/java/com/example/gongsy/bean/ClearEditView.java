...
/**
 * Created by Gongsy on 2017/12/16.
 */

public class ClearEditView extends EditText implements View.OnFocusChangeListener,TextWatcher {
    private Drawable mClearDrawable;
    public ClearEditView(Context context) {this(context,null);}
